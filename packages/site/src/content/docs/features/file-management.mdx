...
import screenshotTree from '../../../assets/screenshot-tree.png';
...
![File tree sidebar showing folder structure with expanded folders and file list](../../../assets/screenshot-tree.png)
